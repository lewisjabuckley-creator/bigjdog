...
class EventType(StrEnum):
    ...
    # goals, plans and agents (Phase 3)
    GOAL_CREATED = "GOAL_CREATED"
    GOAL_CLARIFICATION_NEEDED = "GOAL_CLARIFICATION_NEEDED"
    PLAN_CREATED = "PLAN_CREATED"
    PLAN_VALIDATED = "PLAN_VALIDATED"
    PLAN_STARTED = "PLAN_STARTED"
    PLAN_NODE_STARTED = "PLAN_NODE_STARTED"
    PLAN_NODE_FINISHED = "PLAN_NODE_FINISHED"
