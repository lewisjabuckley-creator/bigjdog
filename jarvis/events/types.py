...
class EventType(StrEnum):
    ...
    # perception (Phase 4)
    INPUT_RECEIVED = "INPUT_RECEIVED"                 # an image, screenshot or document was taken in
    INPUT_REJECTED = "INPUT_REJECTED"                 # unsupported, corrupt, oversized or not permitted
    INPUT_FORGOTTEN = "INPUT_FORGOTTEN"
    PERCEPTION_STARTED = "PERCEPTION_STARTED"
    PERCEPTION_COMPLETED = "PERCEPTION_COMPLETED"
    PERCEPTION_FAILED = "PERCEPTION_FAILED"
    OCR_COMPLETED = "OCR_COMPLETED"
    SCREEN_AWARENESS_CHANGED = "SCREEN_AWARENESS_CHANGED"
    SCREEN_CAPTURED = "SCREEN_CAPTURED"
    SCREEN_STATE_CHANGED = "SCREEN_STATE_CHANGED"
    SCREEN_ERROR_DETECTED = "SCREEN_ERROR_DETECTED"
    DIALOG_APPEARED = "DIALOG_APPEARED"
    APPLICATION_CHANGED = "APPLICATION_CHANGED"
    APPLICATION_CLOSED = "APPLICATION_CLOSED"
    BUILD_FAILED = "BUILD_FAILED"
    IMPORTANT_UI_CHANGE = "IMPORTANT_UI_CHANGE"
